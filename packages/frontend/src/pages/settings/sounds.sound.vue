...
<div class="_gaps_m">
	...
	<div class="_buttons">
		...
		<MkButton inline primary :disabled="!hasChanged || driveFileError" @click="save"><span :class="{ [$style.saved]: saved }"><i :class="saved ? 'ti ti-check' : 'ti ti-device-floppy'"></i> {{ saved ? i18n.ts.saved : i18n.ts.save }}</span></MkButton>
	</div>
</div>
</template>
