...
const {
	...
	items: [
		...
		{ label: i18n.ts.quarantineThisInstance, value: 'quarantined' },
	],
...
const {
	...
	items: [
		...
		{ label: `${i18n.ts._reversi.reversi} (${i18n.ts.descendingOrder})`, value: '+reversiVersion' },
		{ label: `${i18n.ts._reversi.reversi} (${i18n.ts.ascendingOrder})`, value: '-reversiVersion' },
	],
	initialValue: '+pubSub',
});
