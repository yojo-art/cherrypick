...
<div :class="$style.wrapper" data-testid="signin-page-input">
	<div :class="$style.root">
		...
		<form class="_gaps_s" @submit.prevent="emit('usernameSubmitted', username)">
			<MkInput v-model="username" :placeholder="i18n.ts.username" type="text" pattern="^[a-zA-Z0-9_]+$" :spellcheck="false" autocomplete="username webauthn" autofocus required data-testid="signin-username" @enter.prevent="emit('usernameSubmitted', username)">
