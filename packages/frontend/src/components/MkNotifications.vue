		...
		<template #default="{ items: notifications }">
			...
			>
				<template v-for="(notification, i) in notifications" :key="notification.id">
					<MkNote v-if="['reply', 'quote', 'mention'].includes(notification.type)" :class="$style.item" :note="notification.note" :withHardMute="true" :data-scroll-anchor="notification.id" :notification="true" :notificationId="notification.id"/>
					<XNotification v-else :class="$style.item" :notification="notification" :withTime="true" :full="true" :withDelete="true" :data-scroll-anchor="notification.id"/>
				</template>
			</component>
		</template>
	</MkPagination>
