...
export const endpointReqTypes: Record<keyof Endpoints, 'application/json' | 'multipart/form-data'> = {
	...
	'admin/unset-user-mutual-banner': 'application/json',
	...
	'admin/full-index': 'application/json',
	'admin/recreate-index': 'application/json',
	...
	'notes/advanced-search': 'application/json',
	...
	'official-tags/show': 'application/json',
	'official-tags/update': 'application/json',
