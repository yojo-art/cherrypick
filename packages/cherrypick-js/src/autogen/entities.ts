...
export type DriveFilesUploadServiceRequest = operations['drive___files___upload-service']['requestBody']['content']['application/json'];
export type DriveFilesUploadServiceResponse = operations['drive___files___upload-service']['responses']['200']['content']['application/json'];
export type DriveFilesUploadPreflightRequest = operations['drive___files___upload-preflight']['requestBody']['content']['application/json'];
export type DriveFilesUploadPreflightResponse = operations['drive___files___upload-preflight']['responses']['200']['content']['application/json'];
