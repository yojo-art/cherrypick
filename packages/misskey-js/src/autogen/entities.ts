...
export type AdminCustomSoundsCreateRequest = operations['admin___custom-sounds___create']['requestBody']['content']['application/json'];
export type AdminCustomSoundsCreateResponse = operations['admin___custom-sounds___create']['responses']['200']['content']['application/json'];
export type AdminCustomSoundsDeleteRequest = operations['admin___custom-sounds___delete']['requestBody']['content']['application/json'];
export type AdminCustomSoundsListResponse = operations['admin___custom-sounds___list']['responses']['200']['content']['application/json'];
...
export type AnnouncementsReactionsDeleteRequest = operations['announcements___reactions___delete']['requestBody']['content']['application/json'];
...
export type GetCustomSoundsResponse = operations['get-custom-sounds']['responses']['200']['content']['application/json'];
