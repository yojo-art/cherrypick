...
import { isPost, type IActivity } from '@/core/activitypub/type.js';
...
export class QueueService {
	...
	public deliver(user: ThinUser, content: IActivity | null, to: string | null, isSharedInbox: boolean) {
		...
		const isPublicContent = !(isPost(content) && content.to !== 'https://www.w3.org/ns/activitystreams#Public' && content.cc !== 'https://www.w3.org/ns/activitystreams#Public');
