...
const eps = [
	...
	['admin/recreate-index', ep___admin_reCreateIndex],
	...
	['drive/files/upload-service', ep___drive_files_uploadService],
	['drive/files/upload-preflight', ep___drive_files_uploadPreflight],
