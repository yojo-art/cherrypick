...
const $drive_files_uploadService: Provider = { provide: 'ep:drive/files/upload-service', useClass: ep___drive_files_uploadService.default };
const $drive_files_uploadPreflight: Provider = { provide: 'ep:drive/files/upload-preflight', useClass: ep___drive_files_uploadPreflight.default };
