	...
	*/
	...
	describe('匿名検索のsearchableBy', () => {
		...
		beforeAll(async () => {
			...
			anonNotes.privateUserNull = await post(anonPrivate, { text: 'AnonSearchable_private_user_null' });
			anonNotes.privateUserPublic = await post(anonPrivate, { text: 'AnonSearchable_private_user_public', searchableBy: 'public' });
			anonNotes.privateUserPrivate = await post(anonPrivate, { text: 'AnonSearchable_private_user_private', searchableBy: 'private' });
			anonNotes.followersUserNull = await post(anonFollowers, { text: 'AnonSearchable_followers_user_null' });
			anonNotes.reactedUserNull = await post(anonReacted, { text: 'AnonSearchable_reacted_user_null' });
			anonNotes.publicUserNull = await post(anonPublic, { text: 'AnonSearchable_public_user_null' });
			anonNotes.nullUserNull = await post(anonNull, { text: 'AnonSearchable_null_user_null' });
			anonNotes.noIndexUserNull = await post(anonNoIndex, { text: 'AnonSearchable_noindex_user_null' });
			anonNotes.noIndexUserPublic = await post(anonNoIndex, { text: 'AnonSearchable_noindex_user_public', searchableBy: 'public' });
			anonNotes.eventPrivate = await post(anonPrivate, { text: 'AnonSearchable_event', searchableBy: 'private', event: { title: 'AnonSearchableEventPrivate', start: Date.now() } });
			anonNotes.eventPublic = await post(anonPrivate, { text: 'AnonSearchable_event', searchableBy: 'public', event: { title: 'AnonSearchableEventPublic', start: Date.now() } });
